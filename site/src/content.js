...
export const mediaConfig = {
  ...
  ordersVideoSrc: withBaseUpload('encargos-video-romantico-vintage.mp4'),
  ...
  accessImage: withBaseMedia('acceso-atelier.png'),
  atelierVideo: withBaseMedia('atelier-video.mp4'),
  journalVideo: withBaseUpload('diario-taller-terraza-mujer-cosiendo.mp4'),
