...
const withUpload = (filename) => `${import.meta.env.BASE_URL}uploads/${encodeURIComponent(filename)}`

export const mediaConfig = {
  heroVideoEnabled: true,
  heroVideoSrc: withUpload('home-video.mp4'),
  collectionVideoSrc: withUpload('collection-video.mp4'),
  ...
  homeFeaturePhoto: withUpload('home-photo-1.jpg'),
  homePortraitPhoto: withUpload('home-photo-2.jpg'),
