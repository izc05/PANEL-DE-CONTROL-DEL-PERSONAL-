        ...
        <div className="container hero-v4__grid">
          <div className="hero-v4__copy">
            ...
            <div className="home-map" aria-label="Accesos rápidos de portada">
              <button type="button" onClick={() => scrollToHomeLayer('home-collection')}>
                Colección
              </button>
              <button type="button" onClick={() => scrollToHomeLayer('home-orders')}>
                Encargos
              </button>
              <button type="button" onClick={() => scrollToHomeLayer('home-journal')}>
                Diario
              </button>
            </div>
      ...
      <PageSection className="section-block--soft">
        <div className="container">
          <article className="boutique-panel boutique-panel--feature">
            ...
            <video controls playsInline preload="metadata" poster={mediaConfig.visualLead} src={mediaConfig.collectionVideoSrc} />
          </article>
        </div>
      </PageSection>
